...
fn signed_int_to_dec(value: u32) -> i32 {
...
fn fxp_to_flp_smpl(num: i32, e_pos: f32) -> f32 {
    if (num >> 24) == 0 {
...
fn fixed_to_float(fixed_input_num: u64, total_bits: i32, fractional_bits: i32) -> f64 {
    let tmp_u64: u64 = 1;
